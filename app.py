...
ansers = {}
#1が入力された場合の回答を定義
ansers["1"] = ("desknet'sにログインし、以下の手順で申請してください\n"
...
#2が入力された場合の回答を定義
ansers["2"] = ("desknet'sにログインし、以下の手順で申請してください\n"
"1. 左サイドメニューのワークフローをクリック\n"
"2. 「申請の作成」 ボタンをクリック\n"
...
#3が入力された場合の回答を定義
ansers["3"] = ("ManageOZO3にログインし、以下の手順で申請してください。\n"
...
#4が入力された場合の回答文を定義
ansers["4"] = "総務人事グループ　谷口まで電話、メール等でご依頼ください。"

#5が入力された場合の回答文を定義
ansers["5"] = ("以下の手順で申請してください。\n"
...
#6が入力された場合の回答文を定義
ansers["6"] = ("desknet's、ManageOZO3、SYNCNELにてパスワードを規程回数以上間違えるとロックがかかります。\n"
"ロック解除は総務人事グループまでご連絡ください。")

#7が入力された場合の回答文を定義
ansers["7"] = ("以下の書類を提出お願いいたします。\n"
...
def handle_message(event):
    ...
    #入力値に合わせた回答文を編集
    if input_message in ansers:
        reply_message = ansers[input_message]
    else:
        #入力対象外は番号を選択させる文を回答
